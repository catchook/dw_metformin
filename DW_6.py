...
# [3/3] PS matching 
    ...
    print("m2 file size: ", ff.convert_size(file_size), "bytes")
    m2.to_csv('/data/results/'+cohort_hospital+'_m2.csv')
    #check N 
...
# # 1) quantity, days_supply 컬럼 값 붙이기. 
    ...
    print("final1 file size: ", ff.convert_size(file_size), "bytes")
    final1.to_csv('/data/results/'+cohort_hospital+'_final1.csv')
